! function(e, t) {
    ...
    function g(e, t, n, i) {
        var o, r = 1,
            ...
            u = (ge.cssNumber[t] || "px" !== c && +l) && He.exec(ge.css(e, t));
        if (u && u[3] !== c) {
            c = c || u[3], n = n || [], u = +l || 1;
            do {
    ...
    function m(e, t) {
        for (var n, i, o = [], r = 0, s = e.length; r < s; r++) i = e[r], i.style && (n = i.style.display, t ? ("none" === n && (o[r] = Ie.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && Re(i) && (o[r] = v(i))) : "none" !== n && (o[r] = "none", Ie.set(i, "display", n)));
    ...
    function b(e, t, n, i, o) {
        for (var r, s, a, l, c, u, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
            ...
            for (s = s || d.appendChild(t.createElement("div")), a = ($e.exec(r) || ["", ""])[1].toLowerCase(), l = Ue[a] || Ue._default, s.innerHTML = l[1] + ge.htmlPrefilter(r) + l[2], u = l[0]; u--;) s = s.lastChild;
            ge.merge(f, s.childNodes), s = d.firstChild, s.textContent = ""
        } else f.push(t.createTextNode(r));
        for (d.textContent = "", p = 0; r = f[p++];)
            if (i && ge.inArray(r, i) > -1) o && o.push(r);
            else if (c = ge.contains(r.ownerDocument, r), s = y(d.appendChild(r), "script"), c && x(s), n)
    ...
    function L(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Oe.hasData(e) && (a = Oe.access(e), l = ge.extend({}, a), Oe.set(t, l))
        }
    }
    ...
    function N(e, t, i, o) {
        ...
        var r, s, a, l, c, u, d = 0,
            ...
            h = t[0],
            g = ge.isFunction(h);
        if (g || f > 1 && "string" == typeof h && !pe.checkClone && Ze.test(h)) return e.each(function(n) {
            var r = e.eq(n);
            g && (t[0] = h.call(this, n, r.html())), N(r, t, i, o)
        });
        if (f && (r = b(t, e[0].ownerDocument, !1, e, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || o)) {
            for (a = ge.map(y(r, "script"), k), l = a.length; d < f; d++) c = r, d !== p && (c = ge.clone(c, !0, !0), l && ge.merge(a, y(c, "script"))), i.call(e[d], c, d);
            if (l)
                for (u = a[a.length - 1].ownerDocument, ge.map(a, A), d = 0; d < l; d++) c = a[d], Xe.test(c.type || "") && !Ie.access(c, "globalEval") && ge.contains(u, c) && (c.src ? ge._evalUrl && ge._evalUrl(c.src) : n(c.textContent.replace(et, ""), u))
        }
        return e
    }
    ...
    function I(e, t, n) {
        ...
        return n = n || it(e), n && (s = n.getPropertyValue(t) || n[t], "" !== s || ge.contains(e.ownerDocument, e) || (s = ge.style(e, t)), !pe.pixelMarginRight() && nt.test(s) && tt.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function F(e, t, n) {
        ...
        return nt.test(r) ? r : (i = s && (pe.boxSizingReliable() || r === e.style[t]), (r = parseFloat(r) || 0) + H(e, t, n || (s ? "border" : "content"), i, o) + "px")
    }
    ...
    function z() {
        dt && (!1 === ne.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(z) : e.setTimeout(z, ge.fx.interval), ge.fx.tick())
    }
    ...
    function X(e, t, n) {
        ...
        if ((l = !ge.isEmptyObject(t)) || !ge.isEmptyObject(p)) {
            d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], c = v && v.display, null == c && (c = Ie.get(e, "display")), u = ge.css(e, "display"), "none" === u && (c ? u = c : (m([e], !0), c = e.style.display || c, u = ge.css(e, "display"), m([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === ge.css(e, "float") && (l || (f.done(function() {
                h.display = c
            }), null == c && (u = h.display, c = "none" === u ? "" : u)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", f.always(function() {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), l = !1;
            for (i in p) l || (v ? "hidden" in v && (g = v.hidden) : v = Ie.access(e, "fxshow", {
                display: c
    ...
    function _(e, t, n) {
        var i, o, r = 0,
            ...
            l = function() {
                if (o) return !1;
                for (var t = ut || W(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; s < l; s++) c.tweens[s].run(r);
        ...
        for (U(u, c.opts.specialEasing); r < s; r++)
            if (i = _.prefilters[r].call(c, e, u, c.opts)) return ge.isFunction(i.stop) && (ge._queueHooks(c.elem, c.opts.queue).stop = ge.proxy(i.stop, i)), i;
        return ge.map(u, $, c), ge.isFunction(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), ge.fx.timer(ge.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    function Q(e, t, n, i) {
        ...
        if (Array.isArray(t)) ge.each(t, function(t, o) {
            n || St.test(e) ? i(e, o) : Q(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, i)
        });
    ...
    var me = function(e) {
        function t(e, t, n, i) {
            var o, r, s, a, l, u, f, p = t && t.ownerDocument,
                h = t ? t.nodeType : 9;
            ...
            if (!i && ((t ? t.ownerDocument || t : R) !== D && N(t), t = t || D, O)) {
                ...
                if (b.qsa && !X[e + " "] && (!j || !j.test(e))) {
                    if (1 !== h) p = t, f = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(xe, be) : t.setAttribute("id", a = F), u = T(e), r = u.length; r--;) u[r] = "#" + a + " " + d(u[r]);
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || s)
                            if (d = t[F] || (t[F] = {}), u = d[t.uniqueID] || (d[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[i] || t;
                                ...
                                if ((c = u[r]) && c[0] === z && c[1] === a) return f[2] = c[2];
        ...
        function v(e, t, n, o, r, s) {
            return o && !o[F] && (o = v(o)), r && !r[F] && (r = v(r, s)), i(function(i, s, a, l) {
                var c, u, d, f = [],
                    ...
                    x = n ? r || (i ? e : v || o) ? [] : s : y;
                if (n && n(y, x, a, l), o)
                    for (c = g(x, p), o(c, [], a, l), u = c.length; u--;)(d = c[u]) && (x[p[u]] = !(y[p[u]] = d));
                if (i) {
                    if (r || e) {
                        if (r) {
                        ...
                        for (u = x.length; u--;)(d = x[u]) && (c = r ? Z(i, d) : f[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else x = g(x === s ? x.splice(v, x.length) : x), r ? r(null, s, x, l) : G.apply(s, x)
            })
        }

        function m(e) {
            for (var t, n, i, o = e.length, r = w.relative[e[0].type], s = r || w.relative[" "], a = r ? 1 : 0, l = f(function(e) {
                    return e === t
                }, s, !0), c = f(function(e) {
                    return Z(t, e) > -1
                ...
                if (n = w.relative[e[a].type]) u = [f(p(u), n)];
                    ...
                    if (n = w.filter[e[a].type].apply(null, e[a].matches), n[F]) {
                        ...
                        return v(a > 1 && p(u), a > 1 && d(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(re, "$1"), n, a < i && m(e.slice(a, i)), i < o && m(e = e.slice(i)), i < o && d(e))
                    }
                    u.push(n)
                }
            return p(u)
            ...
            var o = n.length > 0,
                ...
                s = function(i, s, a, l, c) {
                    var u, d, f, p = 0,
                        ...
                        S = x.length;
                    for (c && (A = s === D || s || c); h !== S && null != (u = x[h]); h++) {
                        if (r && u) {
                            for (d = 0, s || u.ownerDocument === D || (N(u), a = !O); f = e[d++];)
                                if (f(u, s || D, a)) {
                                    l.push(u);
                                    break
                                }
        ...
        var x, b, w, S, C, T, E, k, A, L, M, N, D, I, O, j, q, P, H, F = "sizzle" + 1 * new Date,
            R = e.document,
            z = 0,
            W = 0,
            B = n(),
        ...
        try {
            G.apply(V = K.call(R.childNodes), R.childNodes), V[R.childNodes.length].nodeType
        } catch (e) {
            G = {
        ...
        b = t.support = {}, C = t.isXML = function(e) {
            ...
            return i !== D && 9 === i.nodeType && i.documentElement ? (D = i, I = D.documentElement, O = !C(D), R !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), b.attributes = o(function(e) {
            ...
            }, q = [], j = [], (b.qsa = he.test(D.querySelectorAll)) && (o(function(e) {
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && j.push("name" + ee + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && j.push(":enabled", ":disabled"), I.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && j.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), j.push(",.*:")
            })), (b.matchesSelector = he.test(P = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function(e) {
                b.disconnectedMatch = P.call(e, "*"), P.call(e, "[s!='']:x"), q.push("!=", ie)
            }), j = j.length && new RegExp(j.join("|")), q = q.length && new RegExp(q.join("|")), t = he.test(I.compareDocumentPosition), H = t || he.test(I.contains) ? function(e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === D || e.ownerDocument === R && H(R, e) ? -1 : t === D || t.ownerDocument === R && H(R, t) ? 1 : L ? Z(L, e) - Z(L, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return M = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
                    ...
                    a = [e],
                    l = [t];
                if (!o || !r) return e === D ? -1 : t === D ? 1 : o ? -1 : r ? 1 : L ? Z(L, e) - Z(L, t) : 0;
                if (o === r) return s(e, t);
            ...
            if ((e.ownerDocument || e) !== D && N(e), n = n.replace(le, "='$1']"), b.matchesSelector && O && !X[n + " "] && (!q || !q.test(n)) && (!j || !j.test(n))) try {
                var i = P.call(e, n);
            ...
            var n = w.attrHandle[t.toLowerCase()],
                i = n && _.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !O) : void 0;
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (M = !b.detectDuplicates, L = !b.sortStable && e.slice(0), e.sort(U), M) {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        if (v) {
                            ...
                            if (h = [s ? v.firstChild : v.lastChild], s && y) {
                                for (f = v, d = f[F] || (f[F] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], p = c[0] === z && c[1], x = p && c[2], f = p && v.childNodes[p]; f = ++p && f && f[g] || (x = p = 0) || h.pop();)
                                    if (1 === f.nodeType && ++x && f === t) {
                                        u[e] = [z, p, x];
                                        break
                                    }
                            } else if (y && (f = t, d = f[F] || (f[F] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], p = c[0] === z && c[1], x = p), !1 === x)
                                for (;
                                    (f = ++p && f && f[g] || (x = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++x || (y && (d = f[F] || (f[F] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), u[e] = [z, x]), f !== t)););
        ...
        return u.prototype = w.filters = w.pseudos, w.setFilters = new u, T = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === f.length) {
                if (r = f[0] = f[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && 9 === t.nodeType && O && w.relative[r[1].type]) {
                ...
                for (o = de.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !w.relative[a = s.type]);)
                    if ((l = w.find[a]) && (i = l(s.matches[0].replace(me, ye), ve.test(r[0].type) && c(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = i.length && d(r))) return G.apply(n, i), n;
                        break
                    }
            }
            return (u || E(e, f))(i, t, !O, n, !t || ve.test(e) && c(t.parentNode) || t), n
        }, b.sortStable = F.split("").sort(U).join("") === F, b.detectDuplicates = !!M, N(), b.sortDetached = o(function(e) {
    ...
    ge.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!r(this, "string" == typeof e && be.test(e) ? ge(e) : e || [], !1).length
        }
    });
    var Ce, Te = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (ge.fn.init = function(e, t, n) {
        ...
        if (n = n || Ce, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof ge ? t[0] : t, ge.merge(this, ge.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)), we.test(i[1]) && ge.isPlainObject(t))
    ...
    ge.fn.extend({
        ...
        ge.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = ge.filter(i, o)), this.length > 1 && (ke[e] || ge.uniqueSort(o), Ee.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var Ae = /[^\x20\t\r\n\f]+/g;
                                ...
                                var a = this,
                                    ...
                                    f = o ? d : function() {
                                        try {
                                            ...
                                            ge.Deferred.exceptionHook && ge.Deferred.exceptionHook(e, f.stackTrace), t + 1 >= s && (i !== c && (a = void 0, u = [e]), n.rejectWith(a, u))
                                        }
                                    };
    ...
    ge.fn.ready = function(e) {
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --ge.readyWait : ge.isReady) || (ge.isReady = !0, !0 !== e && --ge.readyWait > 0 || Me.resolveWith(ne, [ge]))
        }
    }), ge.ready.then = Me.then, "complete" === ne.readyState || "loading" !== ne.readyState && !ne.documentElement.doScroll ? e.setTimeout(ge.ready) : (ne.addEventListener("DOMContentLoaded", d), e.addEventListener("load", d));
    ...
    ge.extend({
        ...
        data: function(e, t) {
            var n, i, o, r = this[0],
                s = r && r.attributes;
            if (void 0 === e) {
                if (this.length && (o = Oe.get(r), 1 === r.nodeType && !Ie.get(r, "hasDataAttrs"))) {
    ...
    ge.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, s, a, l, c, u, d, f, p, h, g, v = Ie.get(e);
            if (v)
                for (n.handler && (r = n, n = r.handler, o = r.selector), o && ge.find.matchesSelector(Ve, o), n.guid || (n.guid = ge.guid++), (l = v.events) || (l = v.events = {}), (s = v.handle) || (s = v.handle = function(t) {
                        return void 0 !== ge && ge.event.triggered !== t.type ? ge.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(Ae) || [""], c = t.length; c--;) a = Ge.exec(t[c]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p && (d = ge.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = ge.event.special[p] || {}, u = ge.extend({
                    type: p,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, r), (f = l[p]) || (f = l[p] = [], f.delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, h, s) || e.addEventListener && e.addEventListener(p, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, u) : f.push(u), ge.event.global[p] = !0)
        },
        remove: function(e, t, n, i, o) {
            var r, s, a, l, c, u, d, f, p, h, g, v = Ie.hasData(e) && Ie.get(e);
            if (v && (l = v.events)) {
                for (t = (t || "").match(Ae) || [""], c = t.length; c--;)
                    if (a = Ge.exec(t[c]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
                        for (d = ge.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, f = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length; r--;) u = f[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(r, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
                        s && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, v.handle) || ge.removeEvent(e, p, v.handle), delete l[p])
                    } else
        ...
        special: {
            ...
            click: {
                trigger: function() {
                    if (Be.test(this.type) && this.click && o(this, "input")) return this.click(), !1
                },
                _default: function(e) {
                    return o(e.target, "a")
                }
    ...
    ge.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ge.isXMLDoc(e)))
                for (s = y(a), r = y(e), i = 0, o = r.length; i < o; i++) M(r[i], s[i]);
            if (t)
                if (n)
                    for (r = r || y(e), s = s || y(a), i = 0, o = r.length; i < o; i++) L(r[i], s[i]);
                else L(e, a);
        ...
        html: function(e) {
            return Ne(this, function(e) {
                ...
                if ("string" == typeof e && !Ke.test(e) && !Ue[($e.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    ge.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = ge.camelCase(t),
                    l = rt.test(t),
                    c = e.style;
                return l || (t = q(a)), s = ge.cssHooks[t] || ge.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t] : (r = typeof n, "string" === r && (o = He.exec(n)) && o[1] && (n = g(e, t, o), r = "number"), void(null != n && n === n && ("number" === r && (n += o && o[3] || (ge.cssNumber[a] ? "" : "px")), pe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))))
            }
        },
        css: function(e, t, n, i) {
            var o, r, s, a = ge.camelCase(t);
            return rt.test(t) || (t = q(a)), s = ge.cssHooks[t] || ge.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = I(e, t, i)), "normal" === o && t in at && (o = at[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), ge.each(["height", "width"], function(e, t) {
        ge.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !ot.test(ge.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? F(e, t, i) : ze(e, st, function() {
                    return F(e, t, i)
                })
            },
            set: function(e, n, i) {
                ...
                return s && (o = He.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = ge.css(e, t)), P(e, n, s)
            }
        }
        ...
        }, tt.test(e) || (ge.cssHooks[e + t].set = P)
    }), ge.fn.extend({
        css: function(e, t) {
            return Ne(this, function(e, t, n) {
                var i, o, r = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (i = it(e), o = t.length; s < o; s++) r[t[s]] = ge.css(e, t[s], !1, i);
                    return r
                }
    ...
    ge.Animation = ge.extend(_, {
            ...
            var e, t = 0,
                n = ge.timers;
            for (ut = ge.now(); t < n.length; t++)(e = n[t])() || n[t] !== e || n.splice(t--, 1);
            n.length || ge.fx.stop(), ut = void 0
    ...
    ge.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? ge.prop(e, t, n) : (1 === r && ge.isXMLDoc(e) || (o = ge.attrHooks[t.toLowerCase()] || (ge.expr.match.bool.test(t) ? ht : void 0)), void 0 !== n ? null === n ? void ge.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : (i = ge.find.attr(e, t), null == i ? void 0 : i))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    ge.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ge.isFunction(e) ? this.each(function(n) {
                ...
                var t, i, o, r;
                if ("string" === n)
                    for (i = 0, o = ge(this), r = e.match(Ae) || []; t = r[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = Y(this), t && Ie.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Ie.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
    ...
    ge.fn.extend({
        val: function(e) {
            ...
            })) : o ? (t = ge.valHooks[o.type] || ge.valHooks[o.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(/\r/g, "") : null == n ? "" : n)) : void 0
        }
    }), ge.extend({
        valHooks: {
            option: {
    ...
    ge.extend(ge.event, {
        trigger: function(t, n, i, o) {
            var r, s, a, l, c, u, d, f = [i || ne],
                p = ue.call(t, "type") ? t.type : t,
                h = ue.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || ne, 3 !== i.nodeType && 8 !== i.nodeType && !yt.test(p + ge.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[ge.expando] ? t : new ge.Event(p, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : ge.makeArray(n, [t]), d = ge.event.special[p] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!o && !d.noBubble && !ge.isWindow(i)) {
                    for (l = d.delegateType || p, yt.test(l + p) || (s = s.parentNode); s; s = s.parentNode) f.push(s), a = s;
                    a === (i.ownerDocument || ne) && f.push(a.defaultView || a.parentWindow || e)
                }
                for (r = 0;
                    (s = f[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : d.bindType || p, u = (Ie.get(s, "events") || {})[t.type] && Ie.get(s, "handle"), u && u.apply(s, n), (u = c && s[c]) && u.apply && De(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = p, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), n) || !De(i) || c && ge.isFunction(i[p]) && !ge.isWindow(i) && (a = i[c], a && (i[c] = null), ge.event.triggered = p, i[p](), ge.event.triggered = void 0, a && (i[c] = a)), t.result
            }
        },
    ...
    ge.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !ge(this).is(":disabled") && Tt.test(this.nodeName) && !Ct.test(e) && (this.checked || !Be.test(e))
            }).map(function(e, t) {
                var n = ge(this).val();
    ...
    Dt.href = xt.href, ge.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                var c, f, p, b, w, S = n;
                u || (u = !0, l && e.clearTimeout(l), o = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (b = J(h, C, i)), b = ee(h, b, C, c), c ? (h.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (ge.lastModified[r] = w), (w = C.getResponseHeader("etag")) && (ge.etag[r] = w)), 204 === t || "HEAD" === h.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = b.state, f = b.data, p = b.error, c = !p)) : (p = S, !t && S || (S = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || S) + "", c ? m.resolveWith(g, [f, S, C]) : m.rejectWith(g, [C, S, p]), C.statusCode(x), x = void 0, d && v.trigger(c ? "ajaxSuccess" : "ajaxError", [C, h, c ? f : p]), y.fireWith(g, [C, S]), d && (v.trigger("ajaxComplete", [C, h]), --ge.active || ge.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var o, r, s, a, l, c, u, d, f, p, h = ge.ajaxSetup({}, n),
                g = h.context || h,
            ...
            if (m.promise(C), h.url = ((t || h.url || xt.href) + "").replace(/^\/\//, xt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ae) || [""], null == h.crossDomain) {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = ge.param(h.data, h.traditional)), K(Lt, h, n, C), u) return C;
            d = ge.event && h.global, d && 0 == ge.active++ && ge.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !At.test(h.type), r = h.url.replace(/#.*$/, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(/%20/g, "+")) : (p = h.url.slice(r.length), h.data && (r += (wt.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(/([?&])_=[^&]*/, "$1"), p = (wt.test(r) ? "&" : "?") + "_=" + bt++ + p), h.url = r + p), h.ifModified && (ge.lastModified[r] && C.setRequestHeader("If-Modified-Since", ge.lastModified[r]), ge.etag[r] && C.setRequestHeader("If-None-Match", ge.etag[r])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && C.setRequestHeader("Content-Type", h.contentType), C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Nt + "; q=0.01" : "") : h.accepts["*"]);
            for (f in h.headers) C.setRequestHeader(f, h.headers[f]);
            if (h.beforeSend && (!1 === h.beforeSend.call(g, C, h) || u)) return C.abort();
            if (S = "abort", y.add(h.complete), C.done(h.success), C.fail(h.error), o = K(Mt, h, n, C)) {
                if (C.readyState = 1, d && v.trigger("ajaxSend", [C, h]), u) return C;
    ...
    var It = {
        ...
        Ot = ge.ajaxSettings.xhr();
    pe.cors = !!Ot && "withCredentials" in Ot, pe.ajax = Ot = !!Ot, ge.ajaxTransport(function(t) {
        var n, i;
    ...
    ge.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = ge.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(qt, "$1" + o) : !1 !== t.jsonp && (t.url += (wt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
            return s || ge.error(o + " was not called"), s[0]
        }, t.dataTypes[0] = "json", r = e[o], e[o] = function() {
            s = arguments
        }, i.always(function() {
            void 0 === r ? ge(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, jt.push(o)), s && ge.isFunction(r) && r(s[0]), s = r = void 0
        }), "script"
        ...
        var i, o, r;
        return t || (pe.createHTMLDocument ? (t = ne.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = ne.location.href, t.head.appendChild(i)) : t = ne), o = we.exec(e), r = !n && [], o ? [t.createElement(o[1])] : (o = b([e], t, r), r && r.length && ge(r).remove(), ge.merge([], o.childNodes))
    }, ge.fn.load = function(e, t, n) {
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return a > -1 && (i = V(e.slice(a)), e = e.slice(0, a)), ge.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && ge.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        ge.cssHooks[t] = O(pe.pixelPosition, function(e, n) {
            if (n) return n = I(e, t), nt.test(n) ? ge(e).position()[t] + "px" : n
        })
    }), ge.each({
        Height: "height",
        Width: "width"
    ...
    return ge.noConflict = function(t) {
        return e.$ === ge && (e.$ = Ht), t && e.jQuery === ge && (e.jQuery = Pt), ge
    }, t || (e.jQuery = e.$ = ge), ge
    ...
    function() {
        ...
        function e(n) {
            return void 0 === this || Object.getPrototypeOf(this) !== e.prototype ? new e(n) : (T = this, T.version = "3.3.4", T.tools = new C, T.isSupported() ? (T.tools.extend(T.defaults, n || {}), T.defaults.container = t(T.defaults), T.store = {
                elements: {},
                containers: []
        ...
        function f() {
            ...
            T.tools.forOwn(T.sequences, function(o) {
                i = T.sequences[o], e = !1;
                for (var r = 0; r < i.elemIds.length; r++) n = i.elemIds[r], t = T.store.elements[n], S(t) && !e && (e = !0);
                i.active = e
            })
        }
        ...
        function y(e) {
            if (e.sequence) {
                return !T.sequences[e.sequence.id].active && e.config.reset && e.revealing && !e.disabled
            }
        ...
        function S(e) {
            ...
            return function() {
                var t = a + r * o,
                    ...
                    g = i.x + e.config.viewOffset.left,
                    v = i.y - e.config.viewOffset.bottom + n.height,
                    m = i.x - e.config.viewOffset.right + n.width;
                return t < v && f > h && d > g && p < m
            }() || function() {
        ...
        e.prototype.defaults = {
            ...
            var f, p, h, g, v, m;
            if (void 0 !== s && "number" == typeof s ? (a = s, s = {}) : void 0 !== s && null !== s || (s = {}), f = t(s), p = n(e, f), !p.length) return T;
            a && "number" == typeof a && (m = i(), v = T.sequences[m] = {
                id: m,
                interval: a,
                elemIds: [],
                active: !1
            });
            for (var y = 0; y < p.length; y++) g = p[y].getAttribute("data-sr-id"), g ? h = T.store.elements[g] : (h = {
                id: i(),
                domEl: p[y],
                seen: !1,
                revealing: !1
            }, h.domEl.setAttribute("data-sr-id", h.id)), v && (h.sequence = {
                id: v.id,
                index: v.elemIds.length
            }, v.elemIds.push(h.id)), o(h, s, f), r(h), l(h), T.tools.isMobile() && !h.config.mobile || !T.isSupported() ? (h.domEl.setAttribute("style", h.styles.inline), h.disabled = !0) : h.revealing || h.domEl.setAttribute("style", h.styles.inline + h.styles.transform.initial);
            return !d && T.isSupported() && (c(e, s, a), T.initTimeout && window.clearTimeout(T.initTimeout), T.initTimeout = window.setTimeout(u, 0)), T
            ...
            if (!e(r).data("bxSlider")) {
                var l = function() {
                    ...
                    c = function() {
                        ...
                        r.wrap('<div class="' + o.settings.wrapperClass + '"><div class="bx-viewport"></div></div>'), o.viewport = r.parent(), o.settings.ariaLive && !o.settings.ticker && o.viewport.attr("aria-live", "polite"), o.loader = e('<div class="bx-loading" />'), o.viewport.prepend(o.loader), r.css({
                            ...
                            display: "block"
                        })), o.controls.el = e('<div class="bx-controls" />'), o.settings.captions && T(), o.active.last = o.settings.startSlide === v() - 1, o.settings.video && r.fitVids(), ("all" === o.settings.preloadImages || o.settings.ticker) && (t = o.children), o.settings.ticker ? o.settings.pager = !1 : (o.settings.controls && S(), o.settings.auto && o.settings.autoControls && C(), o.settings.pager && w(), (o.settings.controls || o.settings.autoControls || o.settings.pager) && o.viewport.after(o.controls.el)), u(t, d)
                    },
                    u = function(t, n) {
                    ...
                    d = function() {
                        ...
                        o.loader.remove(), y(), "vertical" === o.settings.mode && (o.settings.adaptiveHeight = !0), o.viewport.height(f()), r.redrawSlider(), o.settings.onSliderLoad.call(r, o.active.index), o.initialized = !0, o.settings.responsive && e(window).bind("resize", X), o.settings.auto && o.settings.autoStart && (v() > 1 || o.settings.autoSlideForOnePage) && j(), o.settings.ticker && q(), o.settings.pager && N(o.settings.startSlide), o.settings.controls && O(), o.settings.touchEnabled && !o.settings.ticker && R(), o.settings.keyboardEnabled && !o.settings.ticker && e(document).keydown(F)
                    },
                    f = function() {
                        var t = 0,
                            n = e();
                        if ("vertical" === o.settings.mode || o.settings.adaptiveHeight)
                            if (o.carousel) {
                                var r = 1 === o.settings.moveSlides ? o.active.index : o.active.index * m();
                    ...
                    v = function() {
                        ...
                        if (o.settings.moveSlides > 0)
                            if (o.settings.infiniteLoop) e = Math.ceil(o.children.length / m());
                            else
                    ...
                    y = function() {
                        var e, t, n;
                        o.children.length > o.settings.maxSlides && o.active.last && !o.settings.infiniteLoop ? "horizontal" === o.settings.mode ? (t = o.children.last(), e = t.position(), x(-(e.left - (o.viewport.width() - t.outerWidth())), "reset", 0)) : "vertical" === o.settings.mode && (n = o.children.length - o.settings.minSlides, e = o.children.eq(n).position(), x(-e.top, "reset", 0)) : (e = o.children.eq(o.active.index * m()).position(), o.active.index === v() - 1 && (o.active.last = !0), void 0 !== e && ("horizontal" === o.settings.mode ? x(-e.left, "reset", 0) : "vertical" === o.settings.mode && x(-e.top, "reset", 0)))
                    },
                    x = function(t, n, i, s) {
                        var a, l;
                        o.usingCSS ? (l = "vertical" === o.settings.mode ? "translate3d(0, " + t + "px, 0)" : "translate3d(" + t + "px, 0, 0)", r.css("-" + o.cssPrefix + "-transition-duration", i / 1e3 + "s"), "slide" === n ? (r.css(o.animProp, l), 0 !== i ? r.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function(t) {
                            e(t.target).is(r) && (r.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"), D())
                        }) : D()) : "reset" === n ? r.css(o.animProp, l) : "ticker" === n && (r.css("-" + o.cssPrefix + "-transition-timing-function", "linear"), r.css(o.animProp, l), 0 !== i ? r.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function(t) {
                            e(t.target).is(r) && (r.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"), x(s.resetValue, "reset", 0), P())
                        }) : (x(s.resetValue, "reset", 0), P()))) : (a = {}, a[o.animProp] = t, "slide" === n ? r.animate(a, i, o.settings.easing, function() {
                            D()
                    ...
                    b = function() {
                        for (var t = "", n = "", i = v(), r = 0; r < i; r++) n = "", o.settings.buildPager && e.isFunction(o.settings.buildPager) || o.settings.pagerCustom ? (n = o.settings.buildPager(r), o.pagerEl.addClass("bx-custom-pager")) : (n = r + 1, o.pagerEl.addClass("bx-default-pager")), t += '<div class="bx-pager-item"><a href="" data-slide-index="' + r + '" class="bx-pager-link">' + n + "</a></div>";
                        o.pagerEl.html(t)
                    },
                    w = function() {
                        o.settings.pagerCustom ? o.pagerEl = e(o.settings.pagerCustom) : (o.pagerEl = e('<div class="bx-pager" />'), o.settings.pagerSelector ? e(o.settings.pagerSelector).html(o.pagerEl) : o.controls.el.addClass("bx-has-pager").append(o.pagerEl), b()), o.pagerEl.on("click touchend", "a", M)
                    },
                    S = function() {
                        o.controls.next = e('<a class="bx-next" href="">' + o.settings.nextText + "</a>"), o.controls.prev = e('<a class="bx-prev" href="">' + o.settings.prevText + "</a>"), o.controls.next.bind("click touchend", E), o.controls.prev.bind("click touchend", k), o.settings.nextSelector && e(o.settings.nextSelector).append(o.controls.next), o.settings.prevSelector && e(o.settings.prevSelector).append(o.controls.prev), o.settings.nextSelector || o.settings.prevSelector || (o.controls.directionEl = e('<div class="bx-controls-direction" />'), o.controls.directionEl.append(o.controls.prev).append(o.controls.next), o.controls.el.addClass("bx-has-controls-direction").append(o.controls.directionEl))
                    },
                    C = function() {
                        o.controls.start = e('<div class="bx-controls-auto-item"><a class="bx-start" href="">' + o.settings.startText + "</a></div>"), o.controls.stop = e('<div class="bx-controls-auto-item"><a class="bx-stop" href="">' + o.settings.stopText + "</a></div>"), o.controls.autoEl = e('<div class="bx-controls-auto" />'), o.controls.autoEl.on("click", ".bx-start", A), o.controls.autoEl.on("click", ".bx-stop", L), o.settings.autoControlsCombine ? o.controls.autoEl.append(o.controls.start) : o.controls.autoEl.append(o.controls.start).append(o.controls.stop), o.settings.autoControlsSelector ? e(o.settings.autoControlsSelector).html(o.controls.autoEl) : o.controls.el.addClass("bx-has-controls-auto").append(o.controls.autoEl), I(o.settings.autoStart ? "stop" : "start")
                    },
                    T = function() {
                    ...
                    q = function() {
                        ...
                        "next" === o.settings.autoDirection ? r.append(o.children.clone().addClass("bx-clone")) : (r.prepend(o.children.clone().addClass("bx-clone")), t = o.children.first().position(), d = "horizontal" === o.settings.mode ? -t.left : -t.top), x(d, "reset", 0), o.settings.pager = !1, o.settings.controls = !1, o.settings.autoControls = !1, o.settings.tickerHover && (o.usingCSS ? (s = "horizontal" === o.settings.mode ? 4 : 5, o.viewport.hover(function() {
                            ...
                            }), a = o.settings.speed / u, l = "horizontal" === o.settings.mode ? "left" : "top", c = a * (u - Math.abs(parseInt(i))), P(c)
                        })) : o.viewport.hover(function() {
                            r.stop()
                        }, function() {
                            u = 0, o.children.each(function(t) {
                                u += "horizontal" === o.settings.mode ? e(this).outerWidth(!0) : e(this).outerHeight(!0)
                            }), a = o.settings.speed / u, l = "horizontal" === o.settings.mode ? "left" : "top", c = a * (u - Math.abs(parseInt(r.css(l)))), P(c)
                        })), P()
                    },
                    P = function(e) {
                    ...
                    F = function(e) {
                        ...
                        if (null == new RegExp(t, ["i"]).exec("input|textarea") && H(r)) {
                    ...
                    R = function() {
                        ...
                        }, o.viewport.bind("touchstart MSPointerDown pointerdown", z), o.viewport.on("click", ".bxslider a", function(e) {
                    ...
                    z = function(e) {
                        if (o.controls.el.addClass("disabled"), o.working) e.preventDefault(), o.controls.el.removeClass("disabled");
                            ...
                            o.touch.start.x = n[0].pageX, o.touch.start.y = n[0].pageY, o.viewport.get(0).setPointerCapture && (o.pointerId = t.pointerId, o.viewport.get(0).setPointerCapture(o.pointerId)), o.viewport.bind("touchmove MSPointerMove pointermove", B), o.viewport.bind("touchend MSPointerUp pointerup", $), o.viewport.bind("MSPointerCancel pointercancel", W)
                        }
                    },
                    W = function(e) {
                    ...
                    $ = function(e) {
                        o.viewport.unbind("touchmove MSPointerMove pointermove", B), o.controls.el.removeClass("disabled");
                        var t = e.originalEvent,
                            n = void 0 !== t.changedTouches ? t.changedTouches : [t],
                            i = 0,
                            s = 0;
                    ...
                    X = function(t) {
                        if (o.initialized)
                            if (o.working) window.setTimeout(X, 10);
                            else {
                ...
                return r.goToSlide = function(t, n) {
                    var i, s, a, l, c = !0,
                        ...
                        p = null;
                    if (o.oldIndex = o.active.index, o.active.index = _(t), !o.working && o.active.index !== o.oldIndex) {
                        ...
                        "next" === n ? o.settings.onSlideNext.call(r, o.children.eq(o.active.index), o.oldIndex, o.active.index) || (c = !1) : "prev" === n && (o.settings.onSlidePrev.call(r, o.children.eq(o.active.index), o.oldIndex, o.active.index) || (c = !1)), o.active.last = o.active.index >= v() - 1, (o.settings.pager || o.settings.pagerCustom) && N(o.active.index), o.settings.controls && O(), "fade" === o.settings.mode ? (o.settings.adaptiveHeight && o.viewport.height() !== f() && o.viewport.animate({
                            height: f()
                            ...
                            height: f()
                        }, o.settings.adaptiveHeightSpeed), !o.settings.infiniteLoop && o.carousel && o.active.last ? "horizontal" === o.settings.mode ? (p = o.children.eq(o.children.length - 1), d = p.position(), u = o.viewport.width() - p.outerWidth()) : (i = o.children.length - o.settings.minSlides, d = o.children.eq(i).position()) : o.carousel && o.active.last && "prev" === n ? (s = 1 === o.settings.moveSlides ? o.settings.maxSlides - m() : (v() - 1) * m() - (o.children.length - o.settings.maxSlides), p = r.children(".bx-clone").eq(s), d = p.position()) : "next" === n && 0 === o.active.index ? (d = r.find("> .bx-clone").eq(o.settings.maxSlides).position(), o.active.last = !1) : t >= 0 && (l = t * parseInt(m()), d = o.children.eq(l).position()), void 0 !== d ? (a = "horizontal" === o.settings.mode ? -(d.left - u) : -d.top, x(a, "slide", o.settings.speed)) : o.working = !1), o.settings.ariaHidden && U(o.active.index * m())
                    }
                    ...
                    }, o.settings.pause), o.settings.autoControls && !0 !== e && I("stop"))
                }, r.stopAuto = function(e) {
                    o.interval && (clearInterval(o.interval), o.interval = null, o.settings.autoControls && !0 !== e && I("start"))
    ...
    function(e, t) {
        ...
        e.fn.fullpage = function(a) {
            function l(t, n) {
                t || _t(0), Kt("autoScrolling", t, n);
                var i = e(b);
                a.autoScrolling && !a.scrollBar ? (en.css({
                    overflow: "hidden",
                    height: "100%"
                }), z(kn.recordHistory, "internal"), dn.css({
                    "-ms-touch-action": "none",
                    "touch-action": "none"
                }), i.length && _t(i.position().top)) : (en.css({
                    overflow: "visible",
                    height: "initial"
                }), z(!1, "internal"), dn.css({
                    "-ms-touch-action": "",
            ...
            function ie() {
                var t = e(b).prev(x);
                t.length || !a.loopTop && !a.continuousVertical || (t = e(x).last()), t.length && ze(t, null, !0)
            }

            function oe() {
                var t = e(b).next(x);
                t.length || !a.loopBottom && !a.continuousVertical || (t = e(x).first()), t.length && ze(t, null, !1)
            }

            function re(e, t) {
                $(0, "internal"), se(e, t), $(kn.scrollingSpeed, "internal")
            }

            function se(e, t) {
                var n = Lt(e);
                void 0 !== t ? Nt(e, t) : n.length > 0 && ze(n)
            }
            ...
            function ce(t) {
                if (!dn.hasClass(d)) {
                    pn = !0, fn = Q.height(), e(x).each(function() {
                        var t = e(this).find(O),
                            n = e(this).find(N);
                        a.verticalCentered && e(this).find(T).css("height", kt(e(this)) + "px"), e(this).css("height", fn + "px"), a.scrollOverflow && (n.length ? n.each(function() {
                            Tt(e(this))
                        }) : Tt(e(this))), n.length > 1 && dt(t, t.find(D))
                    });
                    var n = e(b),
                        i = n.index(x);
                    i && re(i + 1), pn = !1, e.isFunction(a.afterResize) && t && a.afterResize.call(dn), e.isFunction(a.afterReBuild) && !t && a.afterReBuild.call(dn)
                }
            }

            function ue(t) {
                var n = tn.hasClass(c);
                t ? n || (l(!1, "internal"), _(!1, "internal"), e(k).hide(), tn.addClass(c), e.isFunction(a.afterResponsive) && a.afterResponsive.call(dn, t)) : n && (l(kn.autoScrolling, "internal"), _(kn.autoScrolling, "internal"), e(k).show(), tn.removeClass(c), e.isFunction(a.afterResponsive) && a.afterResponsive.call(dn, t))
            }

            function de() {
                var t = dn.find(a.sectionSelector);
            ...
            function fe() {
                dn.css({
                    height: "100%",
                    position: "relative"
                }), dn.addClass(r), e("html").addClass(f), fn = Q.height(), dn.removeClass(d), ve(), e(x).each(function(t) {
                    var n = e(this),
                        i = n.find(N),
                        o = i.length;
                    he(n, t), ge(n, t), o > 0 ? pe(n, i, o) : a.verticalCentered && Et(n)
                }), a.fixedElements && a.css3 && e(a.fixedElements).appendTo(tn), a.navigation && ye(), be(), a.scrollOverflow ? ("complete" === n.readyState && xe(), Q.on("load", xe)) : Ce()
            }

            function pe(t, n, i) {
                var o = 100 * i,
                    r = 100 / i;
                n.wrapAll('<div class="' + j + '" />'), n.parent().wrap('<div class="' + I + '" />'), t.find(q).css("width", o + "%"), i > 1 && (a.controlArrows && me(t), a.slidesNavigation && It(t, i)), n.each(function(t) {
                    e(this).css("width", r + "%"), a.verticalCentered && Et(e(this))
                });
                var s = t.find(D);
                s.length && (0 !== e(b).index(x) || 0 === e(b).index(x) && 0 !== s.index()) ? Ut(s, "internal") : n.eq(0).addClass(h)
            }

            function he(t, n) {
                n || 0 !== e(b).length || t.addClass(h), an = e(b), t.css("height", fn + "px"), a.paddingTop && t.css("padding-top", a.paddingTop), a.paddingBottom && t.css("padding-bottom", a.paddingBottom), void 0 !== a.sectionsColor[n] && t.css("background-color", a.sectionsColor[n]), void 0 !== a.anchors[n] && t.attr("data-anchor", a.anchors[n])
            }

            function ge(t, n) {
                void 0 !== a.anchors[n] && t.hasClass(h) && wt(a.anchors[n], n), a.menu && a.css3 && e(a.menu).closest(s).length && e(a.menu).appendTo(tn)
            }

            function ve() {
                dn.find(a.sectionSelector).addClass(y), dn.find(a.slideSelector).addClass(M)
            }

            function me(e) {
                e.find(O).after('<div class="' + X + '"></div><div class="' + V + '"></div>'), "#fff" != a.controlArrowColor && (e.find(Y).css("border-color", "transparent transparent transparent " + a.controlArrowColor), e.find(U).css("border-color", "transparent " + a.controlArrowColor + " transparent transparent")), a.loopHorizontal || e.find(U).hide()
            }
            ...
            function ye() {
                ...
                for (var n = 0; n < e(x).length; n++) {
                    ...
                    var o = '<li><a href="#' + i + '"><span></span></a>',
                        r = a.navigationTooltips[n];
                    void 0 !== r && "" !== r && (o += '<div class="' + A + " " + a.navigationPosition + '">' + r + "</div>"), o += "</li>", t.find("ul").append(o)
                }
                e(k).css("margin-top", "-" + e(k).height() / 2 + "px"), e(k).find("li").eq(e(b).index(x)).find("a").addClass(h)
            }
            ...
            function Ce() {
                var t = e(b);
                t.addClass(v), a.scrollOverflowHandler.afterRender && a.scrollOverflowHandler.afterRender(t), Ve(t), Ye(t), a.scrollOverflowHandler.afterLoad(), Te() && e.isFunction(a.afterLoad) && a.afterLoad.call(t, t.data("anchor"), t.index(x) + 1), e.isFunction(a.afterRender) && a.afterRender.call(dn)
            }
            ...
            function Ee() {
                ...
                if (!a.autoScrolling || a.scrollBar) {
                    ...
                    if (Ae(o) && (e(b).hasClass(v) || e(b).addClass(v).siblings().removeClass(v)), t = e(c).eq(r), !t.hasClass(h)) {
                        An = !0;
                        var f, p, g = e(b),
                            m = g.index(x) + 1,
                            y = St(t),
                            ...
                            S = t.index(x) + 1,
                            C = t.find(D);
                        C.length && (p = C.data("anchor"), f = C.index()), gn && (t.addClass(h).siblings().removeClass(h), e.isFunction(a.onLeave) && a.onLeave.call(g, m, S, y), e.isFunction(a.afterLoad) && a.afterLoad.call(t, w, S), Ge(g), Ve(t), Ye(t), wt(w, S - 1), a.anchors.length && (on = w), Ot(f, p, w, S)), clearTimeout(wn), wn = setTimeout(function() {
                            An = !1
                        }, 100)
                    }
                    a.fitToSection && (clearTimeout(Sn), Sn = setTimeout(function() {
                        a.fitToSection && ke()
                    }, a.fitToSectionDelay))
                }
            }
            ...
            function Ae(t) {
                var n = e(b).position().top,
                    i = n + Q.height();
                return "up" == t ? i >= Q.scrollTop() + Q.height() : n <= Q.scrollTop()
            }
            ...
            function Ne(e) {
                var t = e.originalEvent;
                !Ie(e.target) && a.autoScrolling && Oe(t) && e.preventDefault()
            }

            function De(t) {
                var n = t.originalEvent,
                    o = e(n.target).closest(x);
                if (!Ie(t.target) && Oe(n)) {
                    a.autoScrolling && t.preventDefault();
                    var r = a.scrollOverflowHandler.scrollable(o),
                        s = Xt(n);
                    Dn = s.y, In = s.x, o.find(O).length && i.abs(Nn - In) > i.abs(Mn - Dn) ? !ln && i.abs(Nn - In) > Q.outerWidth() / 100 * a.touchSensitivity && (Nn > In ? mn.m.right && ae(o) : mn.m.left && le(o)) : a.autoScrolling && gn && i.abs(Mn - Dn) > Q.height() / 100 * a.touchSensitivity && (Mn > Dn ? Me("down", r) : Dn > Mn && Me("up", r))
                }
            }
            ...
            function Ie(t, n) {
                n = n || 0;
                var i = e(t).parent();
                return !!(n < a.normalScrollElementTouchThreshold && i.is(a.normalScrollElements)) || n != a.normalScrollElementTouchThreshold && Ie(i, ++n)
            }
            ...
            function je(e) {
                var t = e.originalEvent;
                if (a.fitToSection && en.stop(), Oe(t)) {
                    var n = Xt(t);
                    Mn = n.y, Nn = n.x
                }
            }
            ...
            function Pe(n) {
                ...
                if (a.autoScrolling && !sn && !r) {
                    ...
                    vn.length > 149 && vn.shift(), vn.push(i.abs(s)), a.scrollBar && (n.preventDefault ? n.preventDefault() : n.returnValue = !1);
                    var d = e(b),
                        f = a.scrollOverflowHandler.scrollable(d),
                        p = o - On;
                    return On = o, p > 200 && (vn = []), gn && qe(vn, 10) >= qe(vn, 70) && u && (0 > l ? Me("down", f) : Me("up", f)), !1
                }
                a.fitToSection && en.stop()
            }

            function He(t, n) {
                var i = void 0 === n ? e(b) : n,
                    o = i.find(O),
                    r = o.find(N).length;
                if (!(!o.length || ln || 2 > r)) {
                    var s = o.find(D),
                        l = null;
                    if (l = "left" === t ? s.prev(N) : s.next(N), !l.length) {
                        if (!a.loopHorizontal) return;
                        l = "left" === t ? s.siblings(":last") : s.siblings(":first")
                    }
                    ln = !0, dt(o, l, t)
                }
            }
            ...
            function Re(e) {
                var t = e.position(),
                    n = t.top,
                    i = t.top > jn,
                    o = n - fn + e.outerHeight(),
                    r = a.bigSectionsDestination;
                return e.outerHeight() > fn ? (!i && !r || "bottom" === r) && (n = o) : (i || pn && e.is(":last-child")) && (n = o), jn = n, n
            }
            ...
            function ze(t, n, i) {
                if (void 0 !== t) {
                    ...
                    l.activeSection.is(t) && !pn || a.scrollBar && Q.scrollTop() === l.dtop && !t.hasClass("fp-auto-height") || (l.activeSlide.length && (o = l.activeSlide.data("anchor"), r = l.activeSlide.index()), a.autoScrolling && a.continuousVertical && void 0 !== l.isMovementUp && (!l.isMovementUp && "up" == l.yMovement || l.isMovementUp && "down" == l.yMovement) && (l = $e(l)), (!e.isFunction(a.onLeave) || l.localIsResizing || !1 !== a.onLeave.call(l.activeSection, l.leavingSection, l.sectionIndex + 1, l.yMovement)) && (l.localIsResizing || Ge(l.activeSection), a.scrollOverflowHandler.beforeLeave(), t.addClass(h).siblings().removeClass(h), Ve(t), a.scrollOverflowHandler.onLeave(), gn = !1, Ot(r, o, l.anchorLink, l.sectionIndex), We(l), on = l.anchorLink, wt(l.anchorLink, l.sectionIndex)))
                }
            }

            function We(t) {
                if (a.css3 && a.autoScrolling && !a.scrollBar) At("translate3d(0px, -" + i.round(t.dtop) + "px, 0px)", !0), a.scrollingSpeed ? (clearTimeout(xn), xn = setTimeout(function() {
                    Ue(t)
                }, a.scrollingSpeed)) : Ue(t);
                else {
                    var n = Be(t);
            ...
            function $e(t) {
                return t.isMovementUp ? e(b).before(t.activeSection.nextAll(x)) : e(b).after(t.activeSection.prevAll(x).get().reverse()), _t(e(b).position().top), Fe(), t.wrapAroundElements = t.activeSection, t.dtop = t.element.position().top, t.yMovement = St(t.element), t
            }

            function Xe(t) {
                t.wrapAroundElements && t.wrapAroundElements.length && (t.isMovementUp ? e(w).before(t.wrapAroundElements) : e(S).after(t.wrapAroundElements), _t(e(b).position().top), Fe())
            }

            function Ue(t) {
                Xe(t), e.isFunction(a.afterLoad) && !t.localIsResizing && a.afterLoad.call(t.element, t.anchorLink, t.sectionIndex + 1), a.scrollOverflowHandler.afterLoad(), t.localIsResizing || Ye(t.element), t.element.addClass(v).siblings().removeClass(v), gn = !0, e.isFunction(t.callback) && t.callback.call(this)
            }
            ...
            function Ze() {
                ...
                n && (a.animateAnchor ? Nt(n, i) : re(n, i))
            }
            ...
            function Je() {
                if (!An && !a.lockAnchors) {
                    var e = t.location.hash.replace("#", "").split("/"),
                        ...
                        i = decodeURIComponent(e[1]),
                        o = void 0 === on,
                        r = void 0 === on && void 0 === i && !ln;
                    n.length && (n && n !== on && !o || r || !ln && rn != i) && Nt(n, i)
                }
            }
            ...
            function et(t) {
                ...
                if (!n.is("textarea") && !n.is("input") && !n.is("select") && "true" !== n.attr("contentEditable") && "" !== n.attr("contentEditable") && a.keyboardScrolling && a.autoScrolling) {
                    var i = t.which,
                        o = [40, 38, 32, 33, 34];
                    e.inArray(i, o) > -1 && t.preventDefault(), sn = t.ctrlKey, Cn = setTimeout(function() {
                        ct(t)
                    }, 150)
                }
            }
            ...
            function it(e) {
                2 == e.which && (qn = e.pageY, dn.on("mousemove", ut))
            }

            function ot(e) {
                2 == e.which && dn.off("mousemove")
            }

            function rt() {
                var t = e(this).closest(x);
                e(this).hasClass(B) ? mn.m.left && le(t) : mn.m.right && ae(t)
            }
            ...
            function lt(t) {
                ...
                dt(n, n.find(N).eq(e(this).closest("li").index()))
            }

            function ct(t) {
                var n = t.shiftKey;
                if (gn || !([37, 39].indexOf(t.which) < 0)) switch (t.which) {
                    case 38:
                    case 33:
                        mn.k.up && ie();
                        break;
            ...
            function ut(e) {
                gn && (e.pageY < qn && mn.m.up ? ie() : e.pageY > qn && mn.m.down && oe()), qn = e.pageY
            }
            ...
            function dt(t, n, i) {
                ...
                return r.xMovement = Ct(r.prevSlideIndex, r.slideIndex), r.localIsResizing || (gn = !1), a.onSlideLeave && !r.localIsResizing && "none" !== r.xMovement && e.isFunction(a.onSlideLeave) && !1 === a.onSlideLeave.call(r.prevSlide, r.anchorLink, r.sectionIndex + 1, r.prevSlideIndex, r.xMovement, r.slideIndex) ? void(ln = !1) : (n.addClass(h).siblings().removeClass(h), r.localIsResizing || (Ge(r.prevSlide), Ve(n)), !a.loopHorizontal && a.controlArrows && (o.find(U).toggle(0 !== r.slideIndex), o.find(Y).toggle(!n.is(":last-child"))), o.hasClass(h) && !r.localIsResizing && Ot(r.slideIndex, r.slideAnchor, r.anchorLink, r.sectionIndex), void pt(t, r, !0))
            }

            function ft(t) {
                ht(t.slidesNav, t.slideIndex), t.localIsResizing || (e.isFunction(a.afterSlideLoad) && a.afterSlideLoad.call(t.destiny, t.anchorLink, t.sectionIndex + 1, t.slideAnchor, t.slideIndex), gn = !0, Ye(t.destiny)), ln = !1
            }
            ...
            function pt(e, t, n) {
                ...
                if (a.css3) {
                    ...
                    mt(e.find(q)).css(Vt(r)), bn = setTimeout(function() {
                        n && ft(t)
            ...
            function gt() {
                if (vt(), cn) {
                    ...
                    if (!t.is("textarea") && !t.is("input") && !t.is("select")) {
                        var o = Q.height();
                        i.abs(o - Pn) > 20 * i.max(Pn, o) / 100 && (ce(!0), Pn = o)
                    }
            ...
            function xt(t, n) {
                a.navigation && (e(k).find(g).removeClass(h), t ? e(k).find('a[href="#' + t + '"]').addClass(h) : e(k).find("li").eq(n).find("a").addClass(h))
            }

            function bt(t) {
                a.menu && (e(a.menu).find(g).removeClass(h), e(a.menu).find('[data-menuanchor="' + t + '"]').addClass(h))
            }
            ...
            function Tt(e) {
                if (!e.hasClass("fp-noscroll")) {
                    ...
                    var t, n = a.scrollOverflowHandler,
                        i = n.wrapContent(),
                        o = e.closest(x),
                        r = n.scrollable(e);
                    r.length ? t = n.scrollHeight(e) : (t = e.get(0).scrollHeight, a.verticalCentered && (t = e.find(T).get(0).scrollHeight));
                    var s = fn - parseInt(o.css("padding-bottom")) - parseInt(o.css("padding-top"));
                    t > s ? r.length ? n.update(e, s) : (a.verticalCentered ? e.find(T).wrapInner(i) : e.wrapInner(i), n.create(e, s)) : n.remove(e), e.css("overflow", "")
                }
            }

            function Et(e) {
                e.hasClass(P) || e.addClass(P).wrapInner('<div class="' + C + '" style="height:' + kt(e) + 'px;" />')
            }
            ...
            function At(e, t) {
                t ? mt(dn) : yt(dn), dn.css(Vt(e)), setTimeout(function() {
                    dn.removeClass(u)
                }, 10)
            }
            ...
            function Lt(t) {
                if (!t) return [];
                var n = dn.find(x + '[data-anchor="' + t + '"]');
                return n.length || (n = e(x).eq(t - 1)), n
            }

            function Mt(e, t) {
                var n = t.find(O),
                    i = n.find(N + '[data-anchor="' + e + '"]');
                return i.length || (i = n.find(N).eq(e)), i
            }

            function Nt(e, t) {
                var n = Lt(e);
                n.length && (void 0 === t && (t = 0), e === on || n.hasClass(h) ? Dt(n, t) : ze(n, function() {
                    Dt(n, t)
                }))
            }
            ...
            function Ot(e, t, n, i) {
                var o = "";
                a.anchors.length && !a.lockAnchors && (e ? (void 0 !== n && (o = n), void 0 === t && (t = e), rn = t, jt(o + "/" + t)) : void 0 !== e ? (rn = t, jt(n)) : jt(n)), Pt()
            }

            function jt(e) {
                if (a.recordHistory) location.hash = e;
                else if (cn || un) t.history.replaceState(o, o, "#" + e);
                else {
            ...
            function Pt() {
                ...
                tn[0].className = tn[0].className.replace(s, ""), tn.addClass(p + "-" + r)
            }
            ...
            function Ft() {
                n.addEventListener ? (n.removeEventListener("mousewheel", Pe, !1), n.removeEventListener("wheel", Pe, !1), n.removeEventListener("MozMousePixelScroll", Pe, !1)) : n.detachEvent("onmousewheel", Pe)
            }
            ...
            function Rt() {
                ...
                "DOMMouseScroll" == r ? n[e](i + "MozMousePixelScroll", Pe, !1) : n[e](i + r, Pe, !1)
            }

            function zt() {
                dn.on("mousedown", it).on("mouseup", ot)
            }

            function Wt() {
                dn.off("mousedown", it).off("mouseup", ot)
            }

            function Bt() {
                (cn || un) && (a.autoScrolling && tn.off(En.touchmove).on(En.touchmove, Ne), e(s).off(En.touchstart).on(En.touchstart, je).off(En.touchmove).on(En.touchmove, De))
            }

            function $t() {
                (cn || un) && e(s).off(En.touchstart).off(En.touchmove)
            }

            function Xt(e) {
                var t = [];
                return t.y = void 0 !== e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, t.x = void 0 !== e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, un && Oe(e) && a.scrollBar && (t.y = e.touches[0].pageY, t.x = e.touches[0].pageX), t
            }

            function Ut(e, t) {
                $(0, "internal"), void 0 !== t && (pn = !0), dt(e.closest(O), e), void 0 !== t && (pn = !1), $(kn.scrollingSpeed, "internal")
            }

            function _t(e) {
                var t = i.round(e);
                a.css3 && a.autoScrolling && !a.scrollBar ? At("translate3d(0px, -" + t + "px, 0px)", !1) : a.autoScrolling && !a.scrollBar ? dn.css("top", -t) : en.scrollTop(t)
            }
            ...
            function Qt(t) {
                l(!1, "internal"), te(!1), ne(!1), dn.addClass(d), clearTimeout(bn), clearTimeout(xn), clearTimeout(yn), clearTimeout(wn), clearTimeout(Sn), Q.off("scroll", Ee).off("hashchange", Je).off("resize", gt), G.off("click touchstart", k + " a").off("mouseenter", k + " li").off("mouseleave", k + " li").off("click touchstart", R).off("mouseover", a.normalScrollElements).off("mouseout", a.normalScrollElements), e(x).off("click touchstart", W), clearTimeout(bn), clearTimeout(xn), t && Gt()
            }

            function Gt() {
                _t(0), dn.find("img[data-src], source[data-src], audio[data-src], iframe[data-src]").each(function() {
                    _e(e(this), "src")
                }), dn.find("img[data-srcset]").each(function() {
                    _e(e(this), "srcset")
                }), e(k + ", " + F + ", " + W).remove(), e(x).css({
                    height: "",
                    "background-color": "",
                    padding: ""
                }), e(N).css({
                    ...
                    overflow: "",
                    height: ""
                }), e("html").removeClass(f), tn.removeClass(c), e.each(tn.get(0).className.split(/\s+/), function(e, t) {
                    0 === t.indexOf(p) && tn.removeClass(t)
                }), e(x + ", " + N).each(function() {
                    a.scrollOverflowHandler.remove(e(this)), e(this).removeClass(P + " " + h)
                }), yt(dn), dn.find(T + ", " + q + ", " + O).each(function() {
            ...
            if (e("html").hasClass(f)) return void Zt();
            var en = e("html, body"),
                tn = e("body"),
                nn = e.fn.fullpage;
            a = e.extend({
            ...
            var yn, xn, bn, wn, Sn, Cn, Tn = function() {
                ...
                kn = e.extend(!0, {}, a);
            Zt(), K.click = un, K = e.extend(K, a.scrollOverflowOptions), e.extend(e.easing, {
                easeInOutCubic: function(e, t, n, i, o) {
                    return (t /= o / 2) < 1 ? i / 2 * t * t * t + n : i / 2 * ((t -= 2) * t * t + 2) + n
                }
            }), e(this).length && (nn.setAutoScrolling = l, nn.setRecordHistory = z, nn.setScrollingSpeed = $, nn.setFitToSection = _, nn.setLockAnchors = J, nn.setMouseWheelScrolling = ee, nn.setAllowScrolling = te, nn.setKeyboardScrolling = ne, nn.moveSectionUp = ie, nn.moveSectionDown = oe, nn.silentMoveTo = re, nn.moveTo = se, nn.moveSlideRight = ae, nn.moveSlideLeft = le, nn.fitToSection = ke, nn.reBuild = ce, nn.setResponsive = ue, nn.destroy = Qt, function() {
                a.css3 && (a.css3 = Ht()), a.scrollBar = a.scrollBar || a.hybrid, de(), fe(), te(!0), l(a.autoScrolling, "internal"), vt(), Pt(), "complete" === n.readyState && Ze(), Q.on("load", Ze)
            }(), function() {
                Q.on("scroll", Ee).on("hashchange", Je).blur(st).resize(gt), G.keydown(et).keyup(nt).on("click touchstart", k + " a", at).on("click touchstart", R, lt).on("click", L, tt), e(x).on("click touchstart", W, rt), a.normalScrollElements && (G.on("mouseenter", a.normalScrollElements, function() {
                    ee(!1)
                }), G.on("mouseleave", a.normalScrollElements, function() {
                    ee(!0)
                }))
            }());
            var An = !1,
        ...
        var Z = {
            ...
            create: function(t, n) {
                ...
                i.height(n), i.each(function() {
                    ...
                    n && e.each(Z.iScrollInstances, function() {
                        e(this).destroy()
                    }), n = new IScroll(t.get(0), K), Z.iScrollInstances.push(n), n.wheelOff(), t.data("iscrollInstance", n)
                })
            },
            ...
            scrollable: function(e) {
                return e.find(O).length ? e.find(D).find(l) : e.find(l)
            },
            ...
            update: function(t, n) {
                clearTimeout(Z.refreshId), Z.refreshId = setTimeout(function() {
                    e.each(Z.iScrollInstances, function() {
    ...
    function() {
        function e(e) {
            ...
            e = e || "fa", t = document.querySelectorAll("." + e), Array.prototype.forEach.call(t, function(e) {
                n = e.getAttribute("title"), e.setAttribute("aria-hidden", "true"), i = !e.nextElementSibling || !e.nextElementSibling.classList.contains("sr-only"), n && i && (o = document.createElement("span"), o.innerHTML = n, o.classList.add("sr-only"), e.parentNode.insertBefore(o, e.nextSibling))
            })
        }! function() {
            "use strict";
            ...
            function l(e) {
                return new n(function(t, n) {
                    var i = 0,
                        r = [];
                    0 == e.length && t(r);
                    for (var s = 0; s < e.length; s += 1) o(e[s]).c(function(n) {
                        return function(o) {
            ...
            function c(e) {
                return new n(function(t, n) {
                    for (var i = 0; i < e.length; i += 1) o(e[i]).c(t, n)
                })
            }
            var u, d = [];
            u = function() {
            ...
            n.prototype.g = function(e) {
                ...
                return new n(function(n, o) {
                    i.f.push([e, t, n, o]), a(i)
                })
            }, window.Promise || (window.Promise = n, window.Promise.resolve = o, window.Promise.reject = i, window.Promise.race = c, window.Promise.all = l, window.Promise.prototype.then = n.prototype.c, window.Promise.prototype.catch = n.prototype.g)
        }(),
        function() {
            function e(e) {
                this.el = e;
        ...
        var t = function(e, t, n) {
                function i(e) {
                    return s.body ? e() : void setTimeout(function() {
                        i(e)
                    })
                }

                function o() {
                    a.addEventListener && a.removeEventListener("load", o), a.media = n || "all"
                }
                var r, s = window.document,
                ...
                var c = s.styleSheets;
                a.rel = "stylesheet", a.href = e, a.media = "only x", i(function() {
                    r.parentNode.insertBefore(a, t ? r : r.nextSibling)
                });
                var u = function(e) {
                ...
                return a.addEventListener && a.addEventListener("load", o), a.onloadcssdefined = u, u(o), a
            },
            n = null;
        ! function() {
            function e(e, t) {
                ...
                return new Promise(function(e, n) {
                    if (null === f && (f = !!window.FontFace), f) {
                        var p = new Promise(function(e, t) {
                                function n() {
                                    (new Date).getTime() - d >= l ? t() : document.fonts.load(c(r, r.family), a).then(function(t) {
                        ...
                        function t() {
                            var t;
                            (t = -1 != v && -1 != m || -1 != v && -1 != y || -1 != m && -1 != y) && ((t = v != m && v != y && m != y) || (null === u && (t = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent), u = !!t && (536 > parseInt(t[1], 10) || 536 === parseInt(t[1], 10) && 11 >= parseInt(t[2], 10))), t = u && (v == x && m == x && y == x || v == b && m == b && y == b || v == w && m == w && y == w)), t = !t), t && (S.parentNode && S.parentNode.removeChild(S), clearTimeout(C), e(r))
                        }

                        function f() {
                            if ((new Date).getTime() - d >= l) S.parentNode && S.parentNode.removeChild(S), n(r);
                            else {
                                var e = document.hidden;
                                !0 !== e && void 0 !== e || (v = p.a.offsetWidth, m = h.a.offsetWidth, y = g.a.offsetWidth, t()), C = setTimeout(f, 50)
                            }
                        }
                        var p = new i(a),
                            h = new i(a),
                            ...
                            C = 0;
                        S.dir = "ltr", o(p, c(r, "sans-serif")), o(h, c(r, "serif")), o(g, c(r, "monospace")), S.appendChild(p.a), S.appendChild(h.a), S.appendChild(g.a), document.body.appendChild(S), x = p.a.offsetWidth, b = h.a.offsetWidth, w = g.a.offsetWidth, f(), s(p, function(e) {
                            v = e, t()
                        }), o(p, c(r, '"' + r.family + '",sans-serif')), s(h, function(e) {
                            m = e, t()
                        }), o(h, c(r, '"' + r.family + '",serif')), s(g, function(e) {
                            y = e, t()
                        }), o(g, c(r, '"' + r.family + '",monospace'))
                    })
                })
            }, n = a
        }();
        var i = {
                observe: function(e, t) {
                    for (var i = t.prefix, o = 0; o < e.length; o++) ! function(e) {
                        var t = e.weight ? "-" + e.weight : "",
                            o = e.style ? "-" + e.style : "",
                            r = e.className ? "-" + e.className : "",
                            s = e.className ? "-" + e.className + t + o : "",
                            ...
                            c = function(e) {
                                a.remove(i + r + "-" + e), a.remove(i + s + "-" + e)
                            };
                        l("loading"), new n(e.familyName).load(e.testString).then(function() {
                            l("ready"), c("loading")
                        }, function() {
                            l("failed"), c("loading")
                        })
        ...
        try {
            if (window.FontAwesomeCdnConfig) {
                var s = window.FontAwesomeCdnConfig,
                    a = s.useUrl,
                    l = s.faCdnUrl,
                    c = s.code,
                    u = "FontAwesome",
                    d = e.bind(e, "fa"),
                    f = function() {};
                s.autoA11y.enabled && (function(e) {
                    var t, n = [],
                        i = document,
                        o = i.documentElement.doScroll,
                        r = "DOMContentLoaded",
                        s = (o ? /^loaded|^c/ : /^loaded|^i|^c/).test(i.readyState);
                    s || i.addEventListener(r, t = function() {
                        for (i.removeEventListener(r, t), s = 1; t = n.shift();) t()
                    }), s ? setTimeout(e, 0) : n.push(e)
                }(d), function(e) {
                    "undefined" != typeof MutationObserver && new MutationObserver(e).observe(document, {
                        childList: !0,
                        subtree: !0
                    })
                }(d)), s.reporting.enabled && function(e, t) {
                    var n = !1;
                    return e.split(",").forEach(function(e) {
                        var i = new RegExp(e.trim().replace(".", "\\.").replace("*", "(.*)"));
                        t.match(i) && (n = !0)
                    }), n
                }(s.reporting.domains, location.host) && r.load(l + "/js/stats.js"), cssUrl = "https://" + a + "/" + c + ".css", new n(u).load("ï‰€").then(function() {
                    ((window.FontAwesomeHooks || {}).loaded || f)()
                }, f), s.asyncLoading.enabled ? o.loadAsync(cssUrl) : o.load(cssUrl), i.observe([{
                    familyName: u,
                    testString: "ï‰€"
                }], {
        ...
        e(".pager-item").on("click", function(n) {
            n.preventDefault(), t.goToSlide(e(this).data("slide-index"));
            var i = e(this).data("slide-index"),
                o = e(".info-item[data-info-index = " + i + "]");
            e(this).addClass("active"), e(this).siblings().removeClass("active"), o.addClass("active animated fadeIn"), o.siblings().removeClass("active")
        });
        var n = e(".bxslider1").bxSlider({
            pager: !1,
            controls: !1,
            infiniteLoop: !0,
            minSlides: 1,
            ...
            easing: "linear",
            speed: 500,
            onSlideBefore: function(t, n, i) {
                e(t).siblings().removeClass("active-slide");
                var o = e(t).find("h3").text();
                e("#work-title").text(o)
            },
            onSlideAfter: function(t, n, i) {
                e(t).addClass("active-slide")
            }
        });
        e("#arrow-right").on("click", function() {
            n.goToNextSlide()
        }), e("#arrow-left").on("click", function() {
            n.goToPrevSlide()
        });
        var i = e(".bxslider2").bxSlider({
            pager: !1,
            controls: !1,
            options: "fade",
            speed: 1500,
            ...
            pause: 9e3,
            onSlideBefore: function() {
                e("#slider-right").off("click"), e("#slider-left").off("click")
            },
            onSlideAfter: function() {
                e("#slider-right").on("click", function(e) {
                    i.goToNextSlide()
                }), e("#slider-left").on("click", function(e) {
                    i.goToPrevSlide()
                })
            }
        });
        ...
        e(".testimonial-person").on("click", function(t) {
            o.goToSlide(e(this).data("person"));
            e(this).data("person");
            e(this).siblings().removeClass("active-person"), e(this).addClass("active-person")
        }), e(".nav-icon").on("click", function() {
            e(this).css("display", "none"), e(".nav-box").css("display", "block"), e(".nav-box").animateCss("fadeIn")
        }), e(".nav-box-close").on("click", function() {
            e(".nav-box").animateCss("fadeOut"), e(".nav-box").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                e(this).css("display", "none"), e(".nav-icon").css("display", "block")
            })
        }), e("#nav-list li").on("click", function(t) {
            e(this).addClass("active"), e(this).siblings().removeClass("active"), e(".nav-box").animateCss("fadeOut"), e(".nav-box").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                e(this).css("display", "none"), e(".nav-icon").css("display", "block")
            });
            var n = e(this).data("menuanchor");
            "none" != n && e("html, body").stop().animate({
                scrollTop: e("section[data-anchor='" + n + "']").offset().top
            }, 1500, "swing")
        }), e("#toggle-fullpage").on("click", function() {
            e("body").hasClass("fp-disabled") ? (e("#fullpage").fullpage({
                anchors: ["home", "about", "timelines", "skills", "projects", "education", "testimonials", "quotes", "achievements", "blogs", "footer"],
                scrollingSpeed: 1500
            }), e("body").removeClass("fp-disabled"), e(this).html('<a><i class="fa fa-cog" aria-hidden="true"></i> Remove Full Page Mode</a>'), e(".nav-box, .nav-icon").css("position", "absolute")) : (e("#fullpage").fullpage.destroy("all"), e(this).html('<a><i class="fa fa-cog" aria-hidden="true"></i> Full Page Mode</a>'), e("body").addClass("fp-disabled"), e(".nav-box, .nav-icon").css("position", "fixed"))
        }), e("#toggle-work").on("click", function(t) {
            e(".frame-wrap").css("z-index", "600"), e(".toggle-frame").css("height", "100%"), t.preventDefault()
        }), e(".frame-close").on("click", function() {
            e(".toggle-frame").css("height", "0%"), setTimeout(function() {
                e(".frame-wrap").css("z-index", "-1")
            }, 1500)
        }), e(".bxslider1 li").on("click", function() {
            var t = e(this).data("work");
            n.goToSlide(t), e(this).addClass("active-slide"), e(this).siblings().removeClass("active-slide");
            var i = e(this).find("h3").text();
            e("#work-title").text(i)
        }), e("#toggle-slidetop").on("click", function() {
